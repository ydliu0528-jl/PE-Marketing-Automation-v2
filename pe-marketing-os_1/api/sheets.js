...
async function fetchSheetData(token, sheetId, sheetName) {
  // FORMATTED_VALUE = display text (dates show as "2026/5/9")
  // UNFORMATTED_VALUE = raw values (dates as serial numbers, numbers as numbers)  
  // We use FORMATTED_VALUE so dates come back as readable strings
  const url = `https://sheets.googleapis.com/v4/spreadsheets/${sheetId}/values/${encodeURIComponent(sheetName)}?valueRenderOption=FORMATTED_VALUE&dateTimeRenderOption=FORMATTED_STRING`;
