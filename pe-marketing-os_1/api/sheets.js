...
async function fetchSheetData(token, sheetId, sheetName) {
  // Use FORMATTED_VALUE so dates come back as formatted strings (e.g. "2026/5/9")
  // and dateTimeRenderOption=FORMATTED_STRING gives ISO-like strings for datetime cells
